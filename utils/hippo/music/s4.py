        ...
        [
            ...
            lzip(
                [
                    flag(
                        "dataset",
                        ['youtubemix', 'youtubemix', 'youtubemix-hires'],
                    ),
    ...
    return prod(
        [
            ...
            flag(
                ...
                [
                    '/home/workspace/hippo/outputs/2022-01-13/08-23-55/checkpoints/val/loss-v8.ckpt'
                ],
            ),
        ]
    )
    ...
    return prod(
        [
            ...
            flag(
                "trainer.resume_from_checkpoint",
                [
                    '/home/workspace/hippo/outputs/2022-02-02/22-47-27/checkpoints/last.ckpt'
                ],
            ),
        ]
    )
...
def youtube_statespaces_repro(): # to run
    return prod(
        [
            flag(
                "experiment",
                ['sashimi-beethoven', 'sashimi-youtubemix', 'sashimi-sc09'],
            ),
        ]
    )